...
<body class="bg-gray-100 py-6">
    ...
    <div class="container mx-auto px-4">
        ...
        <form method="post">
            ...
            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition" type="submit">Logout</button>
        </form>            
        </div>
                                            ...
                                            <div class="inline-flex items-center gap-x-3">
                                                ...
                                                <div class="flex items-center gap-x-2">
                                                    <img class="object-cover w-10 h-10 rounded-full"
                                                        ...
                                                        alt="">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">junior
                                                            REIS
                                                        </h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                            @junior</p>
                                            ...
                                            <div class="inline-flex items-center gap-x-3">
                                                ...
                                                <div class="flex items-center gap-x-2">
                                                    <img class="object-cover w-10 h-10 rounded-full"
                                                        ...
                                                        alt="">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Olivia
                                                            Wathan
                                                        </h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                            @oliviawathan</p>
