...
<main class="bg-white max-w-md mx-auto p-8 md:border-t-8 md:border-purple-700 md:p-12 md:my-10 rounded lg:shadow-2xl md:shadow-lg sm:shadow-sm">
        ...
        <section>
            <form class="flex flex-col" method="POST">
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-400 text-small font-bold mb-2 ml-3 select-none" for="emailoruser">Email / Username</label>
  ...
  <div class="relative w-full">
                      <label class="block text-gray-400 focus:text-gray-500 text-small font-bold mb-2 ml-3 select-none" for="password">Password</label>
