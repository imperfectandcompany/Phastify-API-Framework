...
function testUserCanAddIntegration($integrationController) {
    // Assume the service has already been added in a previous test

    // Create integration data
    $integrationData = [
        "service_id" => 1, // Use the service ID from the previous test
    ...
    // Assertions
    customAssert($integrationId !== null, "Failed: Integration creation should return an ID");
}

// Update integration settings
function testUserCanUpdateIntegrationSettings($integrationController) {
    // Assume the service and integration have been added in previous tests
    ...
    $integrationId = 1; // Use the integration ID from the previous test
    ...
    function testUserCanUpdateIntegrationAfterAddingService($integrationController) {
        ...
        $serviceData = [
            "name" => "Spotify",
            "client_id" => "f2a1ed52710d4533bde25be6da03b6e3", // public identifier for app
        ...
        $integrationData = [
            ...
            "token_type" => "Bearer",
            "status" => "Active",
            "show_to_followers"=> false, // Update to not show to followers
            "show_to_contacts" => false,  // Update to show to contacts
        ];
        ...
        $integrationId = $integrationController->getNewlyCreatedIntegrationId();

        // Define the updated settings
        $updatedSettings = [
            "show_to_followers" => false, // Update to not show to followers
            "show_to_contacts" => true,  // Update to show to contacts
        ];
